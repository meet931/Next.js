...
export default function Shop({
  ...
  if (params.slug?.length === 2) {
    return (
      <h1>
        Viewing Details of Feature: {params.slug[0]} and Concept:{" "}
        {params.slug[1]}
      </h1>
    );
  ...
  return (
    <>
      ...
      <Link href="shop/1"><h2>Shop 1</h2></Link>
      <Link href="shop/2"><h2>Shop 2</h2></Link>
      <Link href="shop/3"><h2>Shop 3</h2></Link>
